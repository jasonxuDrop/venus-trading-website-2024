...
const products = [
  ...
  { name: 'Product 4', description: 'Connect with third-party tools', href: '#', icon: SquaresPlusIcon },
  { name: 'Product 5', description: 'Build strategic funnels that will convert', href: '#', icon: ArrowPathIcon },
]
